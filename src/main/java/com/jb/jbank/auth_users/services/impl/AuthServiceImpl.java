...
import com.jb.jbank.auth_users.repo.PasswordResetCodeRepository;
import com.jb.jbank.auth_users.repo.UserRepository;
import com.jb.jbank.auth_users.services.AuthService;
import com.jb.jbank.auth_users.services.CodeGenerator;
...
public class AuthServiceImpl implements AuthService {
    ...
    public Response<String> register(RegistrationRequest request) {
        ...
        if (request.getRoles() == null || request.getRoles().isEmpty()) {
            ...
            novaRole.setName("CUSTOMER");
            roleRepository.saveAndFlush(novaRole);
    ...
    public Response<LoginResponse> login(LoginRequest loginRequest) {
        ...
        User user = userRepository.findByEmail(email)
                .orElseThrow(() -> new NotFoundException("Email not found our incorrect!"));
    ...
    public Response<?> forgetPassword(String email) {
        ...
        PasswordResetCode resetCode = PasswordResetCode
                .builder()
                .user(user)
                .code(code)
        ...
        emailVariables.put("name", user.getFirstName());
        emailVariables.put("resetLink", resetLink + code);

        NotificationDTO accountForgotPassowrd = NotificationDTO.builder()
        ...
        notificationService.sendEmail(accountForgotPassowrd, user);
    ...
    public Response<?> updatePasswordViaResetCode(ResetPasswordRequest resetPasswordRequest) {
        ...
        NotificationDTO updatedPassword = NotificationDTO.builder()
                .recipient(user.getEmail())
        ...
        notificationService.sendEmail(updatedPassword, user);
